...
// `is_steady_state_for_gate` (G17 C1) was reverted 2026-05-10 — D0
// research (planning/STRUCTURAL_ENTRY_SPANS_AND_LOCALITY.md) showed
// that filtering by `CutKinematics::{Helix, Plunge}` hides terrain-
// following steady-state cuts on adaptive3d, not configured entries.
// D7 will reintroduce a span-ancestry-based filter once D4–D6 emit
// structural Entry spans from the operation generators.
