...
`a_plunge_is_a_named_fraction_of_the_side_feed_g10`, `a_ramp_off_the_g6_claim_holds_its_vertical_rate_at_the_plunge_g10`, `suggest_leaves_the_entry_style_to_the_operator_g10`. `feeds_matrix_instrument_fm1` is an `#[ignore]` instrument (`-- --ignored`) that writes planning/feeds_matrix_2026-09-23/. `wanaka_suggest_integration` takes minutes: ask first.
