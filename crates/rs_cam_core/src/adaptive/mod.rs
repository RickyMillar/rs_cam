...
use material_grid::polygon_bbox;
use search::{find_entry_point, path_bounds, search_direction_with_metrics};
...
mod tests {
    ...
    use super::search::{compute_engagement, search_direction};
    use super::*;
