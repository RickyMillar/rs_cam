...
- `grid2.rs`, `grid_field.rs` — the generic row-major grid and its math.
...
- `edge_distance.rs`, `fiber.rs` — the indexed point-to-boundary distance
  field, and the fiber and interval types for push cutter and waterline.
