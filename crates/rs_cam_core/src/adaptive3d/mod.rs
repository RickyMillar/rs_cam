...
use crate::adaptive_shared::{average_angles, target_engagement_fraction};
...
mod search;
use search::{
    blend_corners_3d, compute_engagement_3d, find_entry_3d, is_clear_path_3d,
    material_remaining_at_level, material_remaining_in_region, search_direction_3d_with_metrics,
};
...
mod tests {
    use super::search::search_direction_3d;
    use super::*;
