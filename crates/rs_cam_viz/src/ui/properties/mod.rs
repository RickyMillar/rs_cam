...
use crate::state::toolpath::{
    ...
    HeightContext, OperationConfig, ProfileSide, RetractStrategy, SpiralDirection, ToolpathEntry,
    ToolpathId, TraceCompensation, UiProcessRole,
};
...
use feeds_speeds::{
    calculate_and_apply_feeds, draw_entry_preview_diagram, draw_speed_controls,
    draw_vendor_lut_viewer, prov_from_chipload,
};
