...
use panel_apply::{
    apply_keep_out_draft, apply_machine, apply_machine_import, apply_machine_kinematics,
    apply_panel_command, apply_setup_draft, flush_machine_snapshot, flush_post_snapshot,
    flush_tool_draft, flush_toolpath_snapshot, machine_panel_fields_moved,
};
