...
| [F-040](findings/F-040-lead-in-out-feed-breakout.md) | Lead-in / lead-out feed-rate breakout (separate `DressupConfig` knobs + `MoveIntent::{LeadIn,LeadOut}`) | dressup + emitter | low | S-M | open — design only; independent of F-039 |
