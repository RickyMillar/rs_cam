...
| [F-036a](findings/F-036a-feed-modulation-gcode-emission.md) | G-code emitter per-move F-word emission (F-036 Piece C) | post-process | medium | M | open — depends on F-036 (landed) |
| [F-036b](findings/F-036b-feed-modulation-flag-plumbing.md) | `SimulationOptions::adaptive_feed_modulation` flag + simulator-→-modulation wiring + 7 acceptance tests (F-036 Piece D) | sim | medium | M | open — depends on F-036a |
