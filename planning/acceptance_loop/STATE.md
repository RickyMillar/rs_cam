...
| [F-038b](findings/F-038b-adaptive3d-keep-tool-down.md) | Adaptive3d keep-tool-down link between cut groups — dexel-heightfield-safe stay-down replacing retract-rapid-plunge | sim | medium | M | **in flight 2026-05-27** — agent landing code |
