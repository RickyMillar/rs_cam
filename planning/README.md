...
Historical planning snapshots that are still useful for context but are no longer source-of-truth live in [`archive/`](archive/):

- `FEATURE_GAP_REPORT.md`
- `GUI_WIRING_CATALOG.md`
...
- Research notes and source captures belong in `research/` and `reference/`.
