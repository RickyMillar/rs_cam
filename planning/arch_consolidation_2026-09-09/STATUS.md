...
| WP13 | `UiCommand` split and the cross-surface sentry | IN PROGRESS (moves + sentry, 2026-09-11 night; plan §21; classification DRAFT committed) | `WP13_CLASSIFICATION_DRAFT.md`: McpRequestKind 76 rows, AppEvent 133 rows, 9 open calls, 9 plan mismatches |
