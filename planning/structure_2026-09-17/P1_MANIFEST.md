...
| `planning/ui_overlays_ux_2026-09-08/` | 7 | 3 881 762 | Screenshot evidence for the overlay audit. The audit shipped as the P6 Overlays panel (`f7e5e0b1`); the pictures are spent |
