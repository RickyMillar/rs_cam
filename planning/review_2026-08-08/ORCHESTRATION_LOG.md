...
| A-8 | optimizer assumptions + retarget fixture | IN PROGRESS 2026-08-13 (post-K baseline; carries the modulation-pin assessment and the inert-aggressiveness census) |
| A-9 | chip-thickness policy (research-only) | NOT STARTED — next slot |
