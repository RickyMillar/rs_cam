...
| T12 | Phase 6 (6A): `MetricContext` into gates, collapse two assembly sites, `criteria()` slice, gating derives from criteria() | 6 | IN PROGRESS (2026-06-07) | tool_load sentries + MCP serde tests |
