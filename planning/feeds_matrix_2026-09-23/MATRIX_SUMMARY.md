...
- Cells run: 38; errors: 0; skipped on the 150 s budget: 0; wall-clock of the subset: 165.5 s.
...
| `feeds.feed_clamped` | 22 |
| `feeds.long_tool_derate` | 38 |
| `feeds.shank_too_large` | 4 |
| `load.chipload.commanded_above_band` | 2 |
