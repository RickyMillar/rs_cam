...
| fn | `sample_with_probe_diameter` | `crates/rs_cam_core/src/classify_probe.rs:287` | 2 |
| fn | `has_split` | `crates/rs_cam_core/src/compute/config.rs:840` | 2 |
| fn | `tip_float_measured` | `crates/rs_cam_core/src/compute/config.rs:1480` | 3 |
| fn | `retract_trip_measurement` | `crates/rs_cam_core/src/compute/config.rs:1494` | 4 |
| fn | `is_populated` | `crates/rs_cam_core/src/compute/sim_prefix.rs:606` | 7 |
| fn | `dexel_stock_to_top_surface_mesh` | `crates/rs_cam_core/src/dexel_mesh.rs:111` | 4 |
...
| fn | `write_to` | `crates/rs_cam_core/src/feeds/suggest.rs:1156` | 2 |
| fn | `preview_field_apply` | `crates/rs_cam_core/src/feeds/suggest.rs:1264` | 3 |
| fn | `render_mesh_composite` | `crates/rs_cam_core/src/fingerprint.rs:831` | 2 |
| fn | `composite_panel_layout` | `crates/rs_cam_core/src/fingerprint.rs:980` | 7 |
| fn | `projected_xy_area_mm2` | `crates/rs_cam_core/src/finish_planner.rs:256` | 5 |
| fn | `reset_surface_build_count` | `crates/rs_cam_core/src/finish_setup.rs:367` | 4 |
| fn | `priority_flood_epsilon` | `crates/rs_cam_core/src/flow_accum.rs:135` | 14 |
| fn | `resolve_flats` | `crates/rs_cam_core/src/flow_accum.rs:203` | 5 |
| fn | `d8_accumulation` | `crates/rs_cam_core/src/flow_accum.rs:385` | 12 |
...
| fn | `is_shipped` | `crates/rs_cam_core/src/scallop.rs:703` | 4 |
| fn | `uncut_core` | `crates/rs_cam_core/src/scallop.rs:1810` | 4 |
| fn | `planned_tier_boundary_polys` | `crates/rs_cam_core/src/session/multitool.rs:626` | 3 |
| fn | `is_covered` | `crates/rs_cam_core/src/slope.rs:78` | 3 |
| fn | `reset_drop_call_count` | `crates/rs_cam_core/src/tier_map.rs:170` | 6 |
| fn | `label_at` | `crates/rs_cam_core/src/tier_map.rs:496` | 11 |
