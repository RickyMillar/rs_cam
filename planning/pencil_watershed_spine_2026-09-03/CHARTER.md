...
>
> Status: **OPEN, evidence phase not started.** This charter frames the
> experiment and its constraints; the pre-registered bars live in
> `FINDINGS.md` and are fixed before any instrument runs.
