...
| 3D | Unified Finish | `unified_finish.rs` + `finish_planner.rs` | Yes | Yes | Experimental (P2.e — regions by true-surface slope, waterline/scallop/raster per region, greedy link-costed routing; sweep-locked defaults 45/75; crease integration + live GUI validation pending) |
