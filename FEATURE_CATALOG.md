...
| 3D | Unified Finish | `unified_finish.rs` + `finish_planner.rs` | Yes | Yes | Experimental (P2.d — regions by true-surface slope, waterline/scallop/raster per region, greedy link-costed routing with surface-link stitching; crease integration + live GUI validation pending) |
