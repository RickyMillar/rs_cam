...
- `monotone_cell_decomposition` (C2) ships **default-off pending the C4 operator surface review**. Production A/B (CLI 2026-08-30, GUI 2026-09-01, figures agree): 1.090× finish tiers, −14 % rapid distance, `membership_fallbacks`/`empty_fallbacks` 0. Do not flip the default; the evidence record is `planning/thin_organic_2026-08-27/FINDINGS.md` §7 and the ranked follow-on avenues are `planning/finishing_status_2026-09-01.md`.
